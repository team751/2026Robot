...
public final class SimMotorConfigs {
   ...
   *
   * <p>This constructor initializes a {@link SimMotorConfigs} object with the necessary parameters
   * for motor simulation, including the motor model, gearing ratio, load moment of inertia, and
  ...
  public Voltage calculateVoltage(Current current, AngularVelocity mechanismVelocity) {
    return Volts.of(
        motor.getVoltage(current.in(Amps), mechanismVelocity.in(RadiansPerSecond) * gearing));
  }
   ...
   *
   * <p>This method uses the {@link DCMotor} model to find the angular velocity for a given current
   * and voltage.
   *
   ...
   *
   * <p>This method uses the {@link DCMotor} model to find the current for a given angular velocity
   * and voltage.
   *
  ...
  public Current calculateCurrent(AngularVelocity mechanismVelocity, Voltage voltage) {
    return Amps.of(
        motor.getCurrent(mechanismVelocity.in(RadiansPerSecond) * gearing, voltage.in(Volts)));
  }
