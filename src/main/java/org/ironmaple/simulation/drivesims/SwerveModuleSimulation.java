...
public class SwerveModuleSimulation {
  ...
  private Vector2 getPropellingForce(
    ...
    this.driveWheelFinalSpeed =
        RadiansPerSecond.of(
            floorVelocityProjectionOnWheelDirectionMPS / config.WHEEL_RADIUS.in(Meters));
  ...
  public SwerveModuleState getCurrentState() {
    return new SwerveModuleState(
        MetersPerSecond.of(
            getDriveWheelFinalSpeed().in(RadiansPerSecond) * config.WHEEL_RADIUS.in(Meters)),
        getSteerAbsoluteFacing());
  }
   ...
   *
   * <p>The values of {@link #getDriveEncoderUnGearedPosition()} are cached at each sub-tick and can
   ...
   *
   * <p>The values of {@link #getSteerRelativeEncoderPosition()} are cached at each sub-tick and can
   * be retrieved using this method.
   *
