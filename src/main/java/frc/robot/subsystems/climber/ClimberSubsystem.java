...
public class ClimberSubsystem extends SubsystemBase {
	// TODO: figure out how to we want the climber to work. should the motors runtoposition? just run until driver says so? what seems more efficient/convienent/helpful?

	private final TalonFX leftClimber = ClimberConstants.leftClimberConfig.createDevice(TalonFX::new);
	private final TalonFX rightClimber = ClimberConstants.rightClimberConfig.createDevice(TalonFX::new);
