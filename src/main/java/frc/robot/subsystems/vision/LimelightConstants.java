...
=======
  public static final Matrix<N3, N1> FRONT_STD_DEVS = VecBuilder.fill(0.2, 0.2, 0); // 3G
  public static final Matrix<N3, N1> SIDE_STD_DEVS = VecBuilder.fill(0.3, 0.3, 0);    // 3
>>>>>>> Stashed changes
...
=======
  public static final double MT_SWITCH_DISTANCE_METERS = 3000;
>>>>>>> Stashed changes
