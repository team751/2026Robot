...
//         LimelightConstants.LimelightBack.name,
...
//     // If theres no april tag seen return null
//     if (LimelightHelpers.getBotPoseEstimate_wpiBlue(LimelightConstants.LimelightBack.name)
//                 .pose
//                 .getX()
//             == 0.0
//         && LimelightHelpers.getBotPoseEstimate_wpiBlue(LimelightConstants.LimelightBack.name)
//                 .pose
//                 .getY()
//             == 0.0) {
//       return null;
